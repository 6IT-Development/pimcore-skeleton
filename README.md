# SIX-IT Pimcore Project Skeleton
...
```bash
COMPOSER_MEMORY_LIMIT=-1 composer create-project six-it/pimcore-skeleton my-project
cd ./my-project
...
1. Initialize the skeleton project using the `six-it/pimcore-source` image
   ``docker run -u `id -u`:`id -g` --rm -v `pwd`:/var/www/html six-it/pimcore-source:php8.3-latest composer create-project six-it/pimcore-skeleton my-project``
